...
```
# Site settings
title: Michael Blog             # title of your website
SEOTitle: Michael Blog			# check out docs for more detail
...
It's possible that you want the two things different. For me, my site-title is **“Michael Blog”** but I want the title shows in search engine is **“陈明新的博客 | Michael Blog”** which is multi-language.
